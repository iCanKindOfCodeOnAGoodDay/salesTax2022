...
nonCa = 33.68 + 63.39 + 31.74 + 38.54 + 101.65 + 28.83
nonCaPossible = salesSep - nonCa # subtract the one known ca sale
remainingSales = salesSep - nonCaPossible
calEstimated = remainingSales * caRatio
...
print(f"Known out of state:                         {nonCaPossible:.2f}")
print(f"Uknown sales:                               {remainingSales:.2f}")
print(f"Estimated out of state:                             {estimatedOutOfState:.2f}")
print(f"Estimated ca sales:                                 {calEstimated:.2f}")
